...
export const UNABLE_TO_ACT_STATUS_IDS = [
	...
	2849, //  (lockActions)
	2850, //  (lockActions, lockControl)
	2851, // In Event (lockActions, lockControl)
	2892, //  (lockActions, lockControl)
	2894, //  (lockActions, lockControl)
	...
	3023, // Hysteria (lockActions, lockControl)
	3024, // Seduced (lockActions, lockControl)
	...
	3479, // Deep Freeze (lockActions)
	3480, // Deep Freeze (lockActions)
	3481, // Deep Freeze (lockActions)
	...
	3702, // Spinning (lockActions)
	3703, // Slippery Slope (lockActions)
	3713, // Sticky (lockActions)
	3719, // Forced March (lockActions)
	3730, // Down for the Count (lockActions, lockControl)
	3737, // Forced March (lockActions)
	3746, // Bubble Gaol (lockActions, lockControl)
	3750, // 拘束 (lockActions, lockControl)
	3780, //  (lockActions)
