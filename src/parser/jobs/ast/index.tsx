	...
	changelog: [
		{
			...
			Changes: () => <>
				Fixed bug where starting stance was always reported forgotten. Improved maximum card draws/plays calculations. Added suggestion for using Draw pre-pull. Added card overwrite tracking and suggestion.
			</>,
