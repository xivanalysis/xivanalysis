	...
	override addChecklistRules() {
		this.checklist.add(new TieredRule({
			...
			description: <Trans id="ast.dots.rule.description">
				Combust III makes up a good portion of your damage. Aim to keep this DoT up at all times. It also can be used to weave (<DataLink action="ASTRAL_DRAW" />) and manage cards, or maneuver around without dropping GCD uptime.
			</Trans>,
