...
export const VIPER = new Meta({
	...
	Description: () => <>
		<Trans id ="vpr.about.description">
			...
			<p>If see alot of suggestions, don't worry and just take small bites at it! You'll be slithering through the battlefield and filling your foes with dread with ease in no time!</p>
		</Trans>
	</>,
