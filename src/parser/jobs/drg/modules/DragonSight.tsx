...
import {calculateExpectedGcdsForTime, ExpectedGcdCountEvaluator} from 'parser/core/modules/ActionWindow/evaluators/ExpectedGcdCountEvaluator'
import {EvaluationOutput, WindowEvaluator} from 'parser/core/modules/ActionWindow/evaluators/WindowEvaluator'
...
export default class DragonSight extends BuffWindow {
	...
	private adjustExpectedGcdCount(window: HistoryEntry<EvaluatedAction[]>) {
		...
		if (this.buffTargetDied(window) === SHORT_WINDOW_FAULT.PARTNER) {
			...
			return -calculateExpectedGcdsForTime(EXPECTED_GCD_COUNT, this.globalCooldown.getEstimate(), window.start, window.end)
		}
