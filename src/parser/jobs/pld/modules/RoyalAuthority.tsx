...
export class RoyalAuthority extends Analyser {
	...
	private onApplySwordOath(event: Events['statusApply']): void {
		...
		if (event.data === this.data.statuses.ATONEMENT_READY.stacksApplied) {
	...
	private onComplete() {
		...
		const swordOathStacks = this.data.statuses.ATONEMENT_READY.stacksApplied
		...
		this.checklist.add(new TieredRule({
			...
			description: <Trans id="pld.sword-oath.checklist.description">
				<DataLink action="ROYAL_AUTHORITY" /> generates {swordOathStacks} stacks of <DataLink status="ATONEMENT_READY" /> to use on <DataLink action="ATONEMENT" />.
