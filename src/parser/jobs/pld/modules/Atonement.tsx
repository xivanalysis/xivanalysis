	...
	private onComplete() {
		...
		this.checklist.add(new TieredRule({
			...
			description: <Trans id="pld.atonement.checklist.description">
				...
				This is effectively the same as getting {stacks} uses of <DataLink showIcon={false} action="ROYAL_AUTHORITY" />. You may drop one use per minute to better align your rotation with buff windows.
			</Trans>,
			tiers: USE_SEVERITY,
			requirements: [
				new Requirement({
