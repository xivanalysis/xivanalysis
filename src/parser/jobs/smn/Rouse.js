	...
	_onComplete() {
		if (this._wasted > 0) {
			this.suggestions.add(new Suggestion({
					...
					content: <Fragment>
					Avoid casting <ActionLink {...ACTIONS.ROUSE
				} /
 				>
				less;
			than;
			{
				this.parser.formatDuration(ROUSE_DURATION)
			}
			before;
			you;
			swap;
			...
			Fragment > ,
				severity:;
			this._wasted > ROUSE_DURATION ? SEVERITY.MAJOR : this._wasted > 5000 ? SEVERITY.MEDIUM : SEVERITY.MINOR,
				why:; `${
