	...
	_onComplete() {
		...
		if (this._lostAetherflow) {
			this.suggestions.add(new Suggestion({
					...
					content: <Fragment>
					Ensure you gain a full 3 stacks of <ActionLink {...ACTIONS.AETHERFLOW
				} /
 				>
				per;
			cast.Every;
...
if (this._lostDreadwyrmAether) {
	this.suggestions.add(new Suggestion({
			...
			content: <Fragment>
			Ensure you always <ActionLink {...ACTIONS.SUMMON_BAHAMUT
		} /
 		>
		before;
	your;
