...
export default class Buffs extends Module {
	...
	_onComplete() {
		this.checklist.add(new Rule({
			...
			description: <Trans id= "sam.buffs.description"> <ActionLink {...ACTIONS.JINPU} /> increases your damage by 12% and <ActionLink {...ACTIONS.SHIFU} /> increases your speed by 12%. Both buffs are key part of Samurai's damage.</Trans>,
			target: 95,
			requirements: [
				new Requirement({
