...
export class HagakureStats extends Analyser {
	static override handle = 'hagakureStat'
	...
	private onComplete() {
		this.statistics.add(new SimpleStatistic({
			title: <Trans id="sam.hagakureStat.statistic.title">
				Hagakure Usage
			</Trans>,
			icon: this.data.actions.HAGAKURE.icon,
			value: `${this.hagakureCounter}`,
			info: <Trans id="sam.hagakureStat.statistic.info">
