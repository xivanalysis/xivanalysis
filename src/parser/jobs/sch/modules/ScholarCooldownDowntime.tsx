...
export default class ScholarCooldownDowntime extends CooldownDowntime {
	...
	override checklistDescription = <Fragment>
		...
		<div><Trans id="sch.aetherflow.cooldown.description">Try to use <ActionLink {...this.data.actions.AETHERFLOW}/> on cooldown throughout the fight. If you have extra Aetherflow charges, cast Energy Drain to do additional damage before casting <ActionLink {...this.data.actions.AETHERFLOW}/>.</Trans></div>
	</Fragment>
}
