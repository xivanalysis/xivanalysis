...
class App extends Component {
	...
	render() {
		...
		error >  < Container >  < Message.Header > Please;
		do not; share;
		links;
		to;
		this;
		site. < /;
		Message.Header >  < p > I & apos;
		m;
		really;
		excited;
		at;
		...
		p >  < /;
		Container >  < /;
		Message >  < ErrorBoundry >  < Switch >  < Route;
		exact;
		path = "/";
		component = { Home } /  >  < Route;
		path = "/:section/:code/last/:combatant?";
		component = { LastFightRedirect } /  >  < Route;
		path = "/find/:code/:fight?";
		component = { Find } /  >  < Route;
		path = "/analyse/:code/:fight/:combatant";
		component = { Analyse } /  >  < /;
		Switch >  < /;
		ErrorBoundry >  < /;
		Fragment > ;
