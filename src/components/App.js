				...
				<Container className={styles.content}>
					<ErrorBoundary>
						<Switch>
							...
							<Route path="/fflogs/:code/last/:combatant?" component={LastFightRedirect}/>
							<Route path="/fflogs/:code/:fight/:combatant" component={Analyse}/>
							<Route path="/fflogs/:code/:fight?" component={Find}/>
						</Switch>
					</ErrorBoundary>
				</Container>
			</div>
